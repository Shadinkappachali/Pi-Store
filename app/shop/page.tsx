...
const PRODUCTS = [
    { id: "1", name: "HyperCharge 65W GaN Fast Charger", price: 2499, originalPrice: 3999, rating: 4.9, reviews: 1250, category: "Chargers", brand: "Pi", image: "https://images.unsplash.com/photo-1583863788434-e58a36330cf0?q=80&w=800&auto=format&fit=crop", available: true },
    { id: "2", name: "SonicSync Pro Wireless Earbuds", price: 1899, originalPrice: 2999, rating: 4.8, reviews: 840, category: "Earphones", brand: "Sonic", image: "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?q=80&w=800&auto=format&fit=crop", available: true },
    { id: "3", name: "PrecisionTrack Wireless Mouse", price: 1299, originalPrice: 1999, rating: 4.7, reviews: 620, category: "Mouse", brand: "Logi", image: "https://images.unsplash.com/photo-1527864550417-7fd91fc51a46?q=80&w=800&auto=format&fit=crop", available: true },
    { id: "4", name: "DuraLink Pro USB-C Cable", price: 799, originalPrice: 1299, rating: 4.9, reviews: 2100, category: "Cables", brand: "Pi", image: "https://images.unsplash.com/photo-1625805721666-3be3d4d3c3cc?q=80&w=800&auto=format&fit=crop", available: true },
    { id: "5", name: "GhostType Mechanical Keyboard", price: 4499, originalPrice: 5999, rating: 4.8, reviews: 310, category: "Keyboards", brand: "Steel", image: "https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?q=80&w=800&auto=format&fit=crop", available: true },
    ...
    { id: "8", name: "NanoHub 7-in-1 Adapter", price: 3299, originalPrice: 4999, rating: 4.9, reviews: 45, category: "USB Hubs", brand: "Pi", image: "https://images.unsplash.com/photo-1616422285623-13ff0167c95c?q=80&w=800&auto=format&fit=crop", available: true },
    { id: "9", name: "SlimFit Laptop Sleeve (14 inch)", price: 1199, originalPrice: 1799, rating: 4.4, reviews: 280, category: "Laptop Bags", brand: "Pi", image: "https://images.unsplash.com/photo-1544377193-33dcf4d68fb5?q=80&w=800&auto=format&fit=crop", available: true },
    { id: "10", name: "CoolStream Laptop Cooling Pad", price: 1599, originalPrice: 2499, rating: 4.3, reviews: 190, category: "Cooling Pads", brand: "Cooler", image: "https://images.unsplash.com/photo-1588505794452-9e59ace3a24e?q=80&w=800&auto=format&fit=crop", available: false },
];

const CATEGORIES = ["Chargers", "Cables", "Earphones", "Mouse", "Keyboards", "Power Banks", "Cases", "USB Hubs", "Laptop Bags"];
const BRANDS = ["Pi", "Sonic", "Logi", "Steel", "Spigen", "Cooler"];
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="space-y-8 overflow-y-auto max-h-[calc(100vh-120px)] pb-10">
                                ...
                                <div>
                                    <h4 className="mb-4 text-xs font-bold uppercase tracking-widest text-gray-400">Max Price: ₹{priceRange[1]}</h4>
                                    <input
                                        type="range"
                                        min="0"
                                        max="10000"
